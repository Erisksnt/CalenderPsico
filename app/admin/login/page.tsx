  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6 border rounded space-y-3">
      ...
      <div className="flex justify-between text-sm">
        <Link className="text-blue-600 hover:underline" href="/admin/forgot-password">Esqueceu a senha?</Link>
        <Link className="text-blue-600 hover:underline" href="/admin/register">Criar conta</Link>
      </div>
